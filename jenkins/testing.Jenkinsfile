        ...
        stage('Env') {
            parallel {
                stage('Client') {
                    ...
                    when {
                        environment name: 'RUN_CLIENT', value: 'true'
                    }
                ...
                stage('Playwright') {
                    ...
                    when {
                        environment name: 'RUN_PLAYWRIGHT', value: 'true'
                    }
                ...
                stage('Mobile') {
                    ...
                    when {
                        environment name: 'RUN_MOBILE', value: 'true'
                    }
                ...
                stage('Emulator') {
                    ...
                    when {
                        environment name: 'RUN_EMULATOR', value: 'true'
                    }
                    ...
                    stages {
                        ...
                        stage('install') {
                            ...
                            steps {
                                dir('mobile') {
                                    sh 'npm ci --cache .npm --prefer-offline --prefix ../server'
                                }
                            }
                        }
                        stage('build') {
                ...
                stage('Server') {
                    when {
                        environment name: 'RUN_SERVER', value: 'true'
                    }
                    agent {
                        docker {
                            image 'xwiillz/node-chromium-mongo:lts-bionic'
